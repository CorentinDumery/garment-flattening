...
bool key_down(igl::opengl::glfw::Viewer& viewer, int key, int modifiers)
{
  switch (key)
  {
    ...
    case 'W':
      if (directional::write_raw_field("../lib/Directional/tutorial/shared/fandisk.rawfield", (viewingMode==HARD_PRESCRIPTION ? rawFieldHard : rawFieldSoft)))
...
int main()
{
  ...
  "  4    Show soft-alignment result" << std::endl <<
  "  W    Save field"<< std::endl;
  
  // Load mesh
  igl::readOFF("../lib/Directional/tutorial/shared/dragon.off", V, F);
